            ...
            <div class="flex">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="left">
                        <x-slot name="trigger">
                            <x-nav-link :active="request()->routeIs(['addProduct','editProduct'.'deleteProduct','products','category'])">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link href="{{ route('addProduct') }}">
                                {{__('Nuevo producto')}}
                            </x-dropdown-link>
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="left">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link href="{{ route('addstock') }}">
                                {{__('Agregar')}}
                            </x-dropdown-link>
                            <x-dropdown-link href="{{ route('products') }}">
                                {{__('Ajustes')}}
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="left">
                        <x-slot name="trigger">
                            <x-nav-link :active="request()->routeIs(['iinProduct', 'noteSale', 'outProduct'])">
                                <span class="inline-flex rounded-md" class="space-x-8">
                                    <button class="inline-flex items-center py-5 text-sm leading-5 font-medium rounded-md">
                                        Ventas
                                        <svg class="ms-2 -me-0.5 h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link href="{{ route('outproduct') }}">
                                {{__('Salida de productos')}}
                            </x-dropdown-link>
                            <x-dropdown-link href="{{ route('inproduct') }}">
